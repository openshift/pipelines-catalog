# Python 3 Source-to-Image (PipelineResource)
...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-python-3-pr/0.1/s2i-python-3.yaml
```
