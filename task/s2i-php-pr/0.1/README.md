# PHP Source-to-Image (PipelineResource)
...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-php-pr/0.1/s2i-php-pr.yaml
```
