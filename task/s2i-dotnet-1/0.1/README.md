...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-dotnet-1/0.1/s2i-dotnet-1.yaml
```
...
This PipelineRun runs the .NET Core 1 Task to fetch a Git repository and builds and
