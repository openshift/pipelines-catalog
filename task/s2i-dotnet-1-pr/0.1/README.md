# .NET Core 1 Source-to-Image (PipelineResource)
...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-dotnet-1-pr/0.1/s2i-dotnet-1-pr.yaml
```
