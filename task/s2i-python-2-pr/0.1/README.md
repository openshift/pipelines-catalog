# Python 2 Source-to-Image (PipelineResource)
...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-python-2-pr/0.1/s2i-python-2-pr.yaml
```
