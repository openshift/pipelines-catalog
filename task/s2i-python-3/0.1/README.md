...
```
kubectl apply -f https://raw.githubusercontent.com/openshift/pipelines-catalog/master/task/s2i-python-3/0.1/s2i-python-3.yaml
```
...
This PipelineRun runs the python 3 Task to fetch a Git repository and builds and
